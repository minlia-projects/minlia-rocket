...
//import com.minlia.rocket.data.generator.DateUtil;
...
//
//    final String projectBase = "./projects/ffast_generator";
//    String author = "will";
//
//    // 全局配置
...
//    dsc.setCredential("");
//    dsc.setUrl("jdbc:mysql://localhost:3306/ffast?useUnicode=true&characterEncoding=utf-8");
...
//    strategy.setInclude(new String[]{"t_sys_king"}); // 需要生成的表
//
...
//        new String[]{"id", "name", "creator_id", "create_time", "last_modify_time",
//            "last_modifier_id"});
//    // 自定义 mapper 父类
...
//    pc.setController("endpoint." + resPrefix);
