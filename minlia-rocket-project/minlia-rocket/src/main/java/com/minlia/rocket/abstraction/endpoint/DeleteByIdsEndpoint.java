...
public interface DeleteByIdsEndpoint<ENTITY extends Serializable, ID extends Serializable> {
  ...
  @ApiOperation(nickname = "deleteByIds",value = "Delete by ids",httpMethod = "DELETE")//,produces =MediaType.APPLICATION_JSON_UTF8_VALUE
  @ResponseStatus(value = HttpStatus.NO_CONTENT)
  public default ResponseEntity<StatefulBody<ENTITY>> deleteByIds(
