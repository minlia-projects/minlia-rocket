...
//})
@FunctionalInterface
public interface CountByConditionEndpoint<ENTITY extends Serializable, QUERY extends QueryRequestBody> {
  ...
  //TODO 添加权限点控制
  @Loggable
  @PostMapping(value = "/countByConditions", produces = {MediaType.APPLICATION_JSON_UTF8_VALUE})
  @ApiOperation(nickname = "countByConditions",value = "Count by conditions",httpMethod = "POST")//,produces =MediaType.APPLICATION_JSON_UTF8_VALUE
  @ResponseStatus(value = HttpStatus.OK)
  public default ResponseEntity<StatefulBody<WithResultBody<Long>>> countByConditions(
